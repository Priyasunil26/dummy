...
assembly=("mysql" "oracle" "postgresql" "snowflake" "googlebigquery" "mongodb")
mysqlassemblies=""
...
yes | cp -rpf $assemblypath/BoldReports.Data.MongoDB.dll $pluginpath
yes | cp -rpf $assemblypath/MongoDB.Bson.dll $pluginpath
yes | cp -rpf $assemblypath/MongoDB.Driver.dll $pluginpath
yes | cp -rpf $assemblypath/MongoDB.Driver.Core.dll $pluginpath
yes | cp -rpf $assemblypath/MongoDB.Libmongocrypt.dll $pluginpath
yes | cp -rpf $assemblypath/DnsClient.dll $pluginpath
done
echo "mongo DB libraries are installed"
;;
esac
done
