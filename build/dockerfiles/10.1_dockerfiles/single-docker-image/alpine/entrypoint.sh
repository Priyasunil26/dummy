...
update_local_service_url() {
	...
	json_content='{
      ...
      "ReportsService": "http://localhost:6507/reporting/reportservice",
      "ReportsViewer": "http://localhost:6508/reporting/viewer"
	}'
	...
	echo "Local service Json file Created and URL updated"
	fi
}
...
cd "$etl_path"
nohup dotnet BoldDataHub.dll --urls=http://localhost:6509 &>/dev/null &
echo "Starting ETL application [ETL Service for Bold Reports.]"
